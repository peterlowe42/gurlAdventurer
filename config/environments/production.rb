Rails.application.configure do
  ...
  config.action_controller.asset_host  = 'https://gurladventures.herokuapp.com/'
  config.action_mailer.asset_host = 'https://gurladventures.herokuapp.com/'
  ...
  ActionMailer::Base.smtp_settings = 
  {
    ...
    :port               => 587,
    :domain             => 'gmail.com',
    :user_name          => 'gurladventures@gmail.com',
